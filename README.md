...
[![x-cmd/install — pillager Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/pillager.svg)](https://x-cmd.com/install/pillager)
...
Total: **2,994** lines of code across **32** files in the top 5 languages.
...
- **Upstream**: <https://github.com/brittonhayes/pillager>
- **License**: MIT
...
- **Stars**: 315 · **Forks**: 22 · **Open issues**: 6 · **Contributors**: 3

## Totals (cumulative)

- **Releases**: 41 · **Merged PRs**: 74 · **Open PRs**: 7 · **Closed issues**: 6 · **Open issues**: 0 · **Commits**: 138
...
_Snapshot: `data/card/260923.yml` · 2026-09-23T04:34:48Z._
